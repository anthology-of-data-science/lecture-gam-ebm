...
![](./images/ebm-animated.gif)

## Intuition how EBM algorithm works (result)

![](./images/ebm-splines.jpg )

## Where to go from here?

- Try EBM on a pneumonia dataset from India ([link](https://data.mendeley.com/datasets/5cs64gdfwp/1))